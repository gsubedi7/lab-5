...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        final GetTopGradeUseCase Top = config.getTopGradeUseCase();
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            final JPanel manageTeamCard = createManageTeamCard(frame, leaveTeamUseCase, getAverageGradeUseCase, Top);
    ...
    private static JPanel createManageTeamCard(JFrame jFrame, LeaveTeamUseCase leaveTeamUseCase,
                                               GetAverageGradeUseCase getAverageGradeUseCase,GetTopGradeUseCase Top ) {
        final JPanel theCard = new JPanel();
        theCard.setLayout(new GridLayout(ROWS, COLS));
        final JTextField courseField = new JTextField(20);
